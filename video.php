                                ...
                                <div class="image-column col-lg-4 col-md-4 col-sm-6">
                                    <div class="inner wow fadeInLeft" data-wow-delay="0ms">
                                        <figure class="image-box">
                                            <img class="lazy-image" src="images/<?=$videos['picture']?>" data-src="images/<?=$videos['picture']?>" alt="">
                                            <a href="<?=$videos['link']?>" class="lightbox-image over-link"><span class="icon flaticon-play-button"></span></a>
                                        </figure>
                                    </div>
                                </div>
